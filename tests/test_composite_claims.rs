use cat_impl::claims::{
    CatToken, ClaimSet, CompositeClaim, CompositeOperator, CompositeClaims,
    composite_utils,
};
...
mod composite_claims_tests {
    ...
    fn test_or_evaluation_with_all_invalid_tokens() {
        ...
        let or_composite = composite_utils::create_or_from_tokens(vec![expired_token1, expired_token2]);
        let validator = CatTokenValidator::new();
    ...
    fn test_nor_evaluation_with_all_invalid_tokens() {
        ...
        let nor_composite = composite_utils::create_nor_from_tokens(vec![expired_token1, expired_token2]);
        let validator = CatTokenValidator::new();
    ...
    fn test_nor_evaluation_with_some_valid_tokens() {
        ...
        let nor_composite = composite_utils::create_nor_from_tokens(vec![valid_token, expired_token]);
        let validator = CatTokenValidator::new();
    ...
    fn test_and_evaluation_with_some_invalid_tokens() {
        ...
        let and_composite = composite_utils::create_and_from_tokens(vec![valid_token, expired_token]);
        let validator = CatTokenValidator::new();
    ...
    fn test_token_with_failing_composite_claims_validation() {
        ...
        let and_composite = composite_utils::create_and_from_tokens(vec![expired_token1, expired_token2]);
        
        let token_with_composite = create_valid_token("main-issuer")
            .with_and_composite(and_composite);
    ...
    fn test_deep_nesting_depth_check() {
        ...
        for _ in 0..15 {  // Create nesting deeper than MAX_NESTING_DEPTH
        ...
        let token_with_deep_composite = create_valid_token("main-issuer")
    ...
    fn test_max_depth_calculation() {
        ...
        let shallow_composite = composite_utils::create_or_from_tokens(vec![create_valid_token("test")]);
