...
fn bench_hmac_operations(c: &mut Criterion) {
    ...
    group.bench_function("key_generation", |b| {
        b.iter(|| {
            black_box(HmacSha256Algorithm::generate_key())
        })
    });
    ...
    for (name, data) in [
        ...
        group.bench_with_input(BenchmarkId::new("sign", name), data, |b, data| {
            b.iter(|| {
                black_box(hmac.sign(data).unwrap())
            })
        });
    }
    ...
    for (name, (data, sig)) in [
        ...
        group.bench_with_input(BenchmarkId::new("verify", name), &(data, sig), |b, (data, sig)| {
            b.iter(|| {
                black_box(hmac.verify(data, sig).unwrap())
            })
        });
    }
...
fn bench_es256_operations(c: &mut Criterion) {
    ...
    group.bench_function("key_generation", |b| {
        b.iter(|| {
            black_box(Es256Algorithm::new_with_key_pair().unwrap())
        })
    });
    ...
    for (name, data) in [
        ...
        group.bench_with_input(BenchmarkId::new("sign", name), data, |b, data| {
            b.iter(|| {
                black_box(es256.sign(data).unwrap())
            })
        });
    }
    ...
    for (name, (data, sig)) in [
        ...
        group.bench_with_input(BenchmarkId::new("verify", name), &(data, sig), |b, (data, sig)| {
            b.iter(|| {
                black_box(es256.verify(data, sig).unwrap())
            })
        });
    }
...
fn bench_ps256_operations(c: &mut Criterion) {
    ...
    group.bench_function("key_generation", |b| {
        b.iter(|| {
            black_box(Ps256Algorithm::new_with_key_pair().unwrap())
        })
    });
    ...
    for (name, data) in [
        ...
        group.bench_with_input(BenchmarkId::new("sign", name), data, |b, data| {
            b.iter(|| {
                black_box(ps256.sign(data).unwrap())
            })
        });
    }
    ...
    for (name, (data, sig)) in [
        ...
        group.bench_with_input(BenchmarkId::new("verify", name), &(data, sig), |b, (data, sig)| {
            b.iter(|| {
                black_box(ps256.verify(data, sig).unwrap())
            })
        });
    }
...
fn bench_crypto_comparison(c: &mut Criterion) {
    ...
    group.bench_function("hmac_sign", |b| {
        b.iter(|| {
            black_box(hmac.sign(test_data).unwrap())
        })
    });
    
    group.bench_function("es256_sign", |b| {
        b.iter(|| {
            black_box(es256.sign(test_data).unwrap())
        })
    });
    
    group.bench_function("ps256_sign", |b| {
        b.iter(|| {
            black_box(ps256.sign(test_data).unwrap())
        })
    });
    ...
    group.bench_function("hmac_verify", |b| {
        b.iter(|| {
            black_box(hmac.verify(test_data, &hmac_sig).unwrap())
        })
    });
    
    group.bench_function("es256_verify", |b| {
        b.iter(|| {
            black_box(es256.verify(test_data, &es256_sig).unwrap())
        })
    });
    
    group.bench_function("ps256_verify", |b| {
        b.iter(|| {
            black_box(ps256.verify(test_data, &ps256_sig).unwrap())
        })
    });
...
fn bench_utility_functions(c: &mut Criterion) {
    ...
    group.bench_function("create_signing_input", |b| {
        b.iter(|| {
            black_box(create_signing_input(header, payload))
        })
    });
    
    group.bench_function("hash_sha256", |b| {
        b.iter(|| {
            black_box(hash_sha256(MEDIUM_DATA))
        })
    });
