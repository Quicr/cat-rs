...
**Linux** [![Ubuntu](https://github.com/Quicr/cat-rs/actions/workflows/ci.yml/badge.svg?branch=main&event=push)](https://github.com/Quicr/cat-rs/actions/workflows/ci.yml?query=branch%3Amain+os%3Aubuntu-latest) | **macOS** [![macOS](https://github.com/Quicr/cat-rs/actions/workflows/ci.yml/badge.svg?branch=main&event=push)](https://github.com/Quicr/cat-rs/actions/workflows/ci.yml?query=branch%3Amain+os%3Amacos-latest) | **Windows** [![Windows](https://github.com/Quicr/cat-rs/actions/workflows/ci.yml/badge.svg?branch=main&event=push)](https://github.com/Quicr/cat-rs/actions/workflows/ci.yml?query=branch%3Amain+os%3Awindows-latest) | [![License](https://img.shields.io/badge/License-BSD_2--Clause-blue.svg)](https://opensource.org/licenses/BSD-2-Clause)
